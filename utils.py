...
def insert_action(directive, source, target, amount, tx, block_num, tx_seq, act_seq, input_data, table_name='action_20161001_20161231'):
    insert_act_sql = """INSERT INTO {} (directive, source, target, amount, tx, block_num, tx_seq, act_seq, input) 
            VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')""".format(table_name, directive, source,
                                                  target, amount, tx, block_num, tx_seq, act_seq, input_data)
...
def insert_multiple_actions(parsed_entries, table_name):
    ...
    for en in parsed_entries:
        sql = """INSERT INTO {} (directive, source, target, amount, tx, block_num, tx_seq, act_seq, input_data) 
